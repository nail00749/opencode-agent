...
/** Fast-tier built-in agents; the fast model profile applies to them. */
export const FAST_AGENT_IDS = ["back-fast", "front-fast", "review-fast", "researcher", "git", "docs"] as const
/** Deep-tier built-in agents; the deep model profile applies to them. */
...
/** Every built-in agent ID, deep tier first, then fast, then explorer. */
